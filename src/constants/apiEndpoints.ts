...
export const TRADE_API_URLS = {
  ...
  /** 관세청_품목별 수출입실적(GW) — Base: `/1220000/Itemtrade` */
  item: "https://apis.data.go.kr/1220000/Itemtrade/getItemtradeList",
  /** 관세청_국가별 수출입실적(GW) — Base: `/1220000/nationtrade` */
  country: "https://apis.data.go.kr/1220000/nationtrade/getNationtradeList",
  /**
   * 관세청_대륙별 수출입실적(GW) — Base: `/1220000/continenttradet` (끝에 `t`, `continenttrade` 아님)
   * 오퍼레이션: `getContinenttradeList`
   */
  continent:
